...
const ProductByCate = () => {
  ...
  const getdata = () => {
    axios
      .get("https://firdos-collection-website.onrender.com/getdata")
      .then((res) => {
  ...
  const getproductbycate = () => {
    axios
      .get("https://firdos-collection-website.onrender.com/getproductbycate")
      .then((res) => {
  ...
  const handleDelete = (id) => {
    axios
      .delete(`https://firdos-collection-website.onrender.com/deleteproductbycate/${id}`)
      .then((res) => {
        if (res.status === 200) {
          getproductbycate();
        } else {
  ...
  //   axios
  //     .put(
  //       `https://firdos-collection-website.onrender.com/updateproductbycate/${productId}`,
  //       data,
  //       {
  //         headers: {
  ...
  const handleUpdate = (e) => {
    ...
    axios
      .put(`https://firdos-collection-website.onrender.com/updateproductbycate/${productId}`, data, {
        headers: {
          "Content-Type": "multipart/form-data",
        },
      })
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("https://firdos-collection-website.onrender.com/addproductbycate", data, {
        headers: {
          "Content-Type": "multipart/form-data",
        },
      })
