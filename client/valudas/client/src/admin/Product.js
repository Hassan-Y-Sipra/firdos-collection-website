...
const Product = () => {
  ...
  const handledelete = (id) => {
    axios
      .delete(`https://firdos-collection-website.onrender.com/deletedata/${id}`)
      .then((res) => {
        if (res.status === 200) {
          getdata();
        } else {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("https://firdos-collection-website.onrender.com/adddata", formData, {
        headers: {
  ...
  //   };
  //   axios
  //     .put(`https://firdos-collection-website.onrender.com/updatedata/${updateData.id}`, updateData)
  //     .then((res) => {
...
data.append("image",proImage)
  ...
  axios.put(`https://firdos-collection-website.onrender.com/updatedata/${proId}`,data,{
    headers:{
      "Content-Type":"multipart/form-data",
    },
  }).then((res)=>{
